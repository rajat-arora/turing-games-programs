...
const MAX_ASTEROIDS : int := 100
const MAX_FRAME_RATE : int := 60
...
const ASTEROID_RADIUS : int := 50
const SHIP_RADIUS : int := 40
const SHIPF_RADIUS : int := 50
...
function CheckForCollision : boolean
   if Cheat = 0 then 
    var radiiSquared : real := (ASTEROID_RADIUS + SHIP_RADIUS - 1) **2
    for i : 1 .. numAsteroids
